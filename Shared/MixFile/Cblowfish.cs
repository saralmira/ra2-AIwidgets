...
{
    internal class Cblowfish
    {
        public void set_key(byte[] key, int cb_key)
        {
            int i, j;
            dword datal, datar;

            m_p = new dword[t_bf_p.Length];
            m_s = new dword[t_bf_s.Length];
        ...
        public void encipher(ref dword xl, ref dword xr) 
        {
            dword Xl = xl;
            dword Xr = xr;
        ...
        public void decipher(ref dword xl, ref dword xr)
        {
            dword Xl = xl;
            dword Xr = xr;
        ...
        public unsafe void encipher(void* s, void* d, int size)
        {
            dword* r = (dword*)s;
            dword* w = (dword*)d;
            size >>= 3;
            while (size-- != 0)
            {
                dword a = reverse(*r++);
                dword b = reverse(*r++);
                encipher(ref a, ref b);
                *w++ = reverse(a);
                *w++ = reverse(b);
            }
        }

        public unsafe void decipher(void* s, void* d, int size)
        {
            dword* r = (dword*)s;
            dword* w = (dword*)d;
            size >>= 3;
        ...
        unsafe dword reverse(dword v)
        {
            byte* ptr = (byte*)&v;
            return ((dword)(*ptr) << 24) | ((dword)(*(ptr + 1)) << 16) | ((dword)(*(ptr + 2)) << 8) | (dword)(*(ptr + 3));
        }

        dword[] m_p;
        dword[] m_s;

        readonly dword[] t_bf_p = new dword[18]
        {
        ...
        readonly dword[] t_bf_s = new dword[4 * 256]
        {
