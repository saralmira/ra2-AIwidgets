...
namespace AIcore
{
    public class AI : INotifyPropertyChanged
    {
        ...
        {
            ini.WriteValue("MarkSection", null, null);
            taskForces.SaveIni();
            scriptTypes.SaveIni();
            teamTypes.SaveIni();
            aITriggerTypes.SaveIni();
        ...
        public static TaskForce NullTaskForce = new TaskForce(null);
        public static ScriptType NullScriptType = new ScriptType(null);
        public static TeamType NullTeamType = new TeamType(null, null, NullScriptType, NullTaskForce);
